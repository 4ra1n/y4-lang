...
func TestGreater(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.helpers, "github.com/4ra1n/y4-lang/assert.Greater")
	}
}
...
func TestGreaterOrEqual(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "github.com/4ra1n/y4-lang/assert.GreaterOrEqual")
	}
}
...
func TestLess(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "github.com/4ra1n/y4-lang/assert.Less")
	}
}
...
func TestLessOrEqual(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "github.com/4ra1n/y4-lang/assert.LessOrEqual")
	}
}
...
func TestPositive(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "github.com/4ra1n/y4-lang/assert.Positive")
	}
}
...
func TestNegative(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "github.com/4ra1n/y4-lang/assert.Negative")
	}
}
